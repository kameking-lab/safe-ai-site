...
### 3.1 Hero
- 一文: 「建設現場の安全衛生、ここに集約。」
- サブ: 「労働安全衛生コンサルタント (登録番号[redacted]) が監修する研究プロジェクト。墜落・足場・重機・粉じん・化学物質まで、職長・元請担当・現場代理人が当日から使えます。」
...
- description: `墜落・足場・クレーン・粉じん・化学物質まで、建設業の現場で当日から使える KY 用紙・朝礼ネタ・年次計画・法令早見を集約。労働安全衛生コンサルタント (登録番号[redacted]) 監修の研究プロジェクト。`
...
## 8. 「[redacted]研究プロジェクト体裁」維持ポイント

- 「労働安全衛生コンサルタント (登録番号[redacted]) 監修の研究プロジェクト」を Hero に明示
