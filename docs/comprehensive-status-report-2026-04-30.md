...
Person（労働安全コンサルタント、登録番号260022）、Organization（安全AIポータル、founder関連）、WebSite（SearchAction付き、法令検索）、Article/NewsArticle/ItemList（事故DB・事例ページ）、Service（教育・コンサルティング、価格スキーマ対応）、HowTo（12ステップ教育手順、部分実装）。
