...
/**
 * 条番号⇄見出し整合テスト（クレーン則・特化則）
 * ※有機則・酸欠則は e-Gov 突合済（CORPORA_EGOV へ昇格・OFFICIAL_CAPTIONS_YUKI_KISOKU / OFFICIAL_CAPTIONS_SANKKETSU_KISOKU）。
 *
 ...
 * ※有機則は 2026-07-03 に生JSONで本則全56条を正本化し CORPORA_EGOV（OFFICIAL_CAPTIONS_YUKI_KISOKU）へ移設済み。
 *
