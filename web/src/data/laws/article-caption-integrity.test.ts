...
import {
  ...
  OFFICIAL_CAPTIONS_IKUJI_KAIGO_KYUGYO_HO,
  OFFICIAL_CAPTIONS_KINTO_HO,
  ...
  OFFICIAL_CAPTIONS_KENSETSU_GYOHO,
  OFFICIAL_CAPTIONS_RODO_KEIYAKU_HO,
  OFFICIAL_CAPTIONS_NENSHA_KISOKU,
  OFFICIAL_CAPTIONS_PATO_YUKI_HO,
  OFFICIAL_CAPTIONS_SHOKUNO,
  OFFICIAL_CAPTIONS_SAITEI_CHINGIN_HO,
  OFFICIAL_CAPTIONS_RODO_KIJUN_SOKO,
  OFFICIAL_CAPTIONS_JOSEI_KISOKU,
  OFFICIAL_CAPTIONS_ROSHI_HO,
...
const CORPORA_EGOV: Array<{
  ...
  // 柱1（育児・介護休業法・一般法 2026-07-03）e-Gov 403AC0000000076（rev 20251001_506AC0000000042）本則を正本化。
  // 旧コーパスは①第21条「育児休業等に関する定めの周知等の措置」を第21条に誤割当（令和3年改正で新第21条＝妊娠・出産等の
  // 申出があった場合の個別周知・意向確認が挿入され、周知等の措置は第21条の2へ移動）＋努力義務を義務と誤記、
  // ②第16条の8 所定外労働の制限を「三歳未満」（令和6年改正・2025-10-01施行で「小学校就学前」へ拡大・かつ第23条 短縮措置の
  // 表現と混在）と記載していた。実在条・現行本文へ是正。
  {
    lawShort: "育介法",
    official: OFFICIAL_CAPTIONS_IKUJI_KAIGO_KYUGYO_HO,
    articles: [...ikujiKaigoKyugyoHo],
  },
  {
    lawShort: "均等法",
    official: OFFICIAL_CAPTIONS_KINTO_HO,
    articles: [...koyoKintoHo],
  },
  // 柱1（建設業法・一般法 2026-07-04）e-Gov 324AC0000000100（rev 20251212_506AC0000000049）本則全条を正本化。
  // 旧コーパスは①第26条の3「技術者の専任」＝正は第26条第3項（第26条の3は特定専門工事の主任技術者職務の兼任）
  // ／②第24条の6「下請負人の意見の聴取」＝正は第24条の2（第24条の6は特定建設業者の下請代金の支払期日等）
  // ／③第40条の3「標識の掲示」＝正は第40条（第40条の3は帳簿の備付け等）の誤割当を含んでいた。
  {
    lawShort: "建設業法",
    official: OFFICIAL_CAPTIONS_KENSETSU_GYOHO,
    articles: [...kensetsuGyoho],
  },
  // 労契法: 収録4条（第1/5/16/18条）はいずれも実在条・公式見出しと一致で条番号の
  // 誤割当は無し。ただし第18条（無期転換）の本文にコーパス独自の誤記があった＝
  // e-Gov生JSON突合で本文を現行条文へ是正のうえ CORPORA_EGOV へ昇格。
  {
    lawShort: "労契法",
    official: OFFICIAL_CAPTIONS_RODO_KEIYAKU_HO,
    articles: [...rodoKeiyakuHo],
  },
  // 柱1（年少者労働基準規則・労基法系省令 2026-07-04）e-Gov 329M50002000013（昭和29年労働省令第13号）本則全10条を正本化。
  // 旧コーパスは①第7条(重量物を取り扱う業務)と第8条(年少者の就業制限の業務の範囲＝危険業務)の本文を条番号ごと取り違え、
  // ②第2条を「深夜業に従事させてはならない業務」とし法第61条第4項由来の本文を実在しない見出しで割り当てていた。
  // 深夜業の実体規定は労基法第61条(rodo-kijun-ho.ts)に既収録のため、年少者則側は実在する第5条(交替制による深夜業の許可申請)へ是正。
  {
    lawShort: "年少者則",
    official: OFFICIAL_CAPTIONS_NENSHA_KISOKU,
    articles: [...nenshaRodoKijunKisoku],
  },
  // 柱1（パートタイム・有期雇用労働法 2026-07-04）e-Gov 405AC0000000076（rev 20200601_501AC0000000024）本則全条を正本化。
  // 収録3条（第1/8/14条）はいずれも実在条。旧コーパスは①第14条を非公式の平易ラベル「給与等の説明」で収録
  // （正＝公式見出し「事業主が講ずる措置の内容等の説明」）していたほか、第14条本文が第1項の緩い要約で
  // 待遇差説明（第2項）を欠き、第1条本文も「短時間労働者及び有期雇用労働者」の旧表記・「福祉の向上」等の
  // 独自表現だった＝いずれも現行条文へ忠実化。第8条は本文まで公式と完全一致で不変。
  {
    lawShort: "パート有期法",
    official: OFFICIAL_CAPTIONS_PATO_YUKI_HO,
    articles: [...tankiRodoShaKanriHo],
  },
  // 柱1（職業能力開発促進法・一般法 2026-07-04）e-Gov 344AC0000000064（rev 20250601_504AC0000000068）本則全条を正本化。
  // 旧コーパスは①第10条の3「事業主の責務」＝正は第4条「関係者の責務」（第10条の3はキャリアコンサルティング等の措置条で別条）
  // ／②第15条の6「技能検定」＝正は第44条「技能検定」（第15条の6は職業に必要な技能に関する広報啓発等で別条）の誤割当を含んでいた。
  // 第1条（目的）は正条だが本文が旧「雇用対策法」（2018年に労働施策総合推進法へ改称）のままだったため現行条文へ是正。
  {
    lawShort: "職能法",
    official: OFFICIAL_CAPTIONS_SHOKUNO,
    articles: [...shokugyoNoryokuKaihatsuSokushinHo],
  },
  // 柱1（最低賃金法 2026-07-04）e-Gov 334AC0000000137（昭和34年法律第137号・rev 20250601）本則全42条を正本化。
  // 旧コーパスは第9条 articleTitle を「地域別最低賃金の決定」（＝実際は第10条の公式見出し）と誤記し、本文に
  // 第10条第1項（審議会の意見を聴いて決定）を第9条第2項（生計費・賃金支払能力の考慮）へ接ぎ木していた。
  // 真の第9条は「地域別最低賃金の原則」＝実在条・公式見出しへ是正し、決定手続の第10条を実在条として補完。
  {
    lawShort: "最賃法",
    official: OFFICIAL_CAPTIONS_SAITEI_CHINGIN_HO,
    articles: [...saiteiChinginHo],
  },
  // 柱1（労働基準法施行規則 2026-07-04）e-Gov 322M40000100023（昭和22年厚生省令第23号・現行版）を正本化。
  // ⚠労基則は公式見出しを持たない（本文内容準拠ラベル）。旧コーパスは内容誤割当2件を含んでいた：
  //   フレックスタイム制→旧第24条の2の2（同条は現行では専門業務型裁量労働制）＝正は第12条の3／
  //   割増賃金の基礎→旧第35条（同条は現行では業務上の疾病＝法75条2項・別表第一の二）＝正は第19条。
  //   加えて第5条（労働条件の明示）は正条だが本文が2024-04-01施行改正前で変更の範囲・更新上限を欠いていた。
  {
    lawShort: "労基則",
    official: OFFICIAL_CAPTIONS_RODO_KIJUN_SOKO,
    articles: [...rodoKijunHoSikokiregu],
  },
  // 柱1（女性労働基準規則 2026-07-04）e-Gov 361M50002000003（昭和61年労働省令第3号・
  // rev 361M50002000003_20190507_501M60000100001）本則全4条を正本化。
  // 旧コーパスは本則3条すべてが誤り：①第1条＝架空の「目的」条（正は「坑内業務の就業制限の範囲」）
  // ／②第2条＝根拠を「法第65条第3項」と誤記（正は「危険有害業務の就業制限の範囲等」・法第64条の3第1項）
  // ／③第3条＝「重量物の取扱い」（正は妊産婦以外の女性への準用規定・法第64条の3第2項）の誤割当を含んでいた。
  {
    lawShort: "女性則",
    official: OFFICIAL_CAPTIONS_JOSEI_KISOKU,
    articles: [...joseiRodoKijunKisoku],
  },
  // 柱1（労働施策総合推進法 2026-07-04）e-Gov 341AC0000000132
  //（rev 341AC0000000132_20260401_507AC0000000063 ＝令和7年法律第63号・2026-04-01 施行）本則全条（第1〜41条）を正本化。
  // インライン未検証だった本法を CORPORA_EGOV へ昇格。corpus-gaps-fill.ts の収録は第30条の2
  //（パワハラ防止の雇用管理上の措置等）1条のみで、実在条・公式見出しと整合＝条番号／見出しの誤割当は無い。
  {
    lawShort: "労施法",
    official: OFFICIAL_CAPTIONS_ROSHI_HO,
    articles: corpusGapFillArticles.filter((a) => a.lawShort === "労施法"),
  },
];
...
describe("条番号⇄見出し整合 安衛則・安衛法（e-Gov 2026-06-10 スナップショット）", () => {
  ...
  // 柱1（育介法）是正の再発防止（旧コーパスで誤っていた組）
  it("既知の誤割当が再発していない（育介法）", () => {
    const k = OFFICIAL_CAPTIONS_IKUJI_KAIGO_KYUGYO_HO;
    // ①育児休業等に関する定めの周知等の措置＝第21条の2（令和3年改正で第21条→第21条の2へ移動）。
    //   新第21条は妊娠又は出産等についての申出があった場合等における措置等（個別周知・意向確認）
    expect(k["第21条の2"]).toBe("育児休業等に関する定めの周知等の措置");
    expect(k["第21条"]).toBe("妊娠又は出産等についての申出があった場合等における措置等");
    // コーパスは周知等の措置を第21条の2へ着地させ、旧・第21条への誤割当を再発させない
    expect(ikujiKaigoKyugyoHo.some((a) => a.articleNum === "第21条の2")).toBe(true);
    expect(ikujiKaigoKyugyoHo.some((a) => a.articleNum === "第21条")).toBe(false);
    const shuchi = ikujiKaigoKyugyoHo.find((a) => a.articleNum === "第21条の2");
    // 周知等の措置は努力義務（講ずるように努めなければならない）＝義務（講じなければならない）ではない
    expect(shuchi?.text.includes("努めなければならない")).toBe(true);
    expect(shuchi?.text.includes("講じなければならない")).toBe(false);
    // ②所定外労働の制限（第16条の8）の対象は令和6年改正（2025-10-01施行）で「小学校就学の始期に達するまでの子」。
    //   「三歳に満たない子」は第23条 所定労働時間の短縮措置等の対象であり混同しない
    const shoteigai = ikujiKaigoKyugyoHo.find((a) => a.articleNum === "第16条の8");
    expect(shoteigai?.text.includes("小学校就学の始期に達するまでの子")).toBe(true);
    expect(shoteigai?.text.includes("三歳に満たない子")).toBe(false);
    expect(k["第23条"]).toBe("所定労働時間の短縮措置等");
    // ③第2条 三要介護状態は現行本則で「厚生労働省令で定める期間」（旧本文の「二週間以上の期間」は本則に不在）
    const teigi = ikujiKaigoKyugyoHo.find((a) => a.articleNum === "第2条");
    expect(teigi?.text.includes("厚生労働省令で定める期間")).toBe(true);
    expect(teigi?.text.includes("二週間以上の期間")).toBe(false);
    // 第36〜52条は現行法で削除。コーパスは参照していない
    expect(k["第36条"]).toBe("削除");
    expect(k["第52条"]).toBe("削除");
    expect(k["第52条の2"]).toBe("苦情の自主的解決");
  });

  // 柱1（均等法）是正の再発防止（旧コーパスは第11条・第11条の3の見出しに非公式ラベルを使用していた）
  it("既知の誤割当が再発していない（均等法）", () => {
    const k = OFFICIAL_CAPTIONS_KINTO_HO;
    // ①セクハラ措置義務＝第11条。公式見出しは「職場における性的な言動に起因する問題に関する雇用管理上の措置等」
    //   （旧コーパスの平易ラベル「職場におけるセクシュアルハラスメント」＝非公式見出しを正本化）
    expect(k["第11条"]).toBe(
      "職場における性的な言動に起因する問題に関する雇用管理上の措置等",
    );
    const seku = koyoKintoHo.find((a) => a.articleNum === "第11条");
    expect(seku?.articleTitle).toBe(
      "職場における性的な言動に起因する問題に関する雇用管理上の措置等",
    );
    // ②マタハラ措置義務＝第11条の3（第11条の2はセクハラの国・事業主・労働者の責務で別条）。
    expect(k["第11条の2"]).toBe(
      "職場における性的な言動に起因する問題に関する国、事業主及び労働者の責務",
    );
    expect(k["第11条の3"]).toBe(
      "職場における妊娠、出産等に関する言動に起因する問題に関する雇用管理上の措置等",
    );
    const mata = koyoKintoHo.find((a) => a.articleNum === "第11条の3");
    // 本文は労基法65条（産前産後休業）を明示する現行条文へ正本化（旧本文の緩い要約を是正）
    expect(mata?.text.includes("労働基準法第六十五条第一項")).toBe(true);
    // ③妊娠中及び出産後の健康管理措置＝第12条（母子保健法の保健指導・健康診査の時間確保）。
    expect(k["第12条"]).toBe("妊娠中及び出産後の健康管理に関する措置");
    const kenko = koyoKintoHo.find((a) => a.articleNum === "第12条");
    expect(kenko?.text.includes("母子保健法")).toBe(true);
    // ④第9条は婚姻・妊娠・出産等の不利益取扱いの禁止＝第11条の3（マタハラ措置義務）と混同しない
    expect(k["第9条"]).toBe("婚姻、妊娠、出産等を理由とする不利益取扱いの禁止等");
  });

  it("既知の誤割当が再発していない（建設業法）", () => {
    const k = OFFICIAL_CAPTIONS_KENSETSU_GYOHO;
    // ①技術者の専任＝第26条第3項（公共性のある重要工事に限る）。第26条の3は特定専門工事の主任技術者職務の兼任で別条。
    expect(k["第26条"]).toBe("主任技術者及び監理技術者の設置等");
    expect(k["第26条第3項"]).toBe("主任技術者及び監理技術者の設置等*"); // 収録項＝継承見出しで照合スキップ
    const sennin = kensetsuGyoho.find((a) => a.articleNum === "第26条第3項");
    expect(sennin?.articleTitle).toBe("技術者の専任");
    // 専任は「公共性のある…重要な建設工事で政令で定めるもの」に限られる（全工事一律ではない）本文へ是正
    expect(sennin?.text.includes("公共性のある")).toBe(true);
    // ②下請負人の意見の聴取＝第24条の2（第24条の6は特定建設業者の下請代金の支払期日等で別条）。
    expect(k["第24条の2"]).toBe("下請負人の意見の聴取");
    expect(k["第24条の6"]).toBe("特定建設業者の下請代金の支払期日等");
    expect(
      kensetsuGyoho.find((a) => a.articleTitle === "下請負人の意見の聴取")?.articleNum,
    ).toBe("第24条の2");
    // ③標識の掲示＝第40条（第40条の3は帳簿の備付け等で別条）。
    expect(k["第40条"]).toBe("標識の掲示");
    expect(k["第40条の3"]).toBe("帳簿の備付け等");
    expect(
      kensetsuGyoho.find((a) => a.articleTitle === "標識の掲示")?.articleNum,
    ).toBe("第40条");
  });

  // 柱1（労契法）是正の再発防止（旧コーパスは第18条 無期転換の本文に独自の誤記があった）
  it("既知の誤割当が再発していない（労契法）", () => {
    const k = OFFICIAL_CAPTIONS_RODO_KEIYAKU_HO;
    // ①安全配慮義務＝第5条。②解雇権濫用法理＝第16条。③無期転換＝第18条（いずれも実在条・公式見出し一致）
    expect(k["第5条"]).toBe("労働者の安全への配慮");
    expect(k["第16条"]).toBe("解雇");
    expect(k["第18条"]).toBe("有期労働契約の期間の定めのない労働契約への転換");
    // ④第18条本文の是正: 旧コーパスは括弧書きを「契約期間の合計が五年を超えるものに限る」と
    //   誤記し「契約期間が通算して五年を超える」としていた。現行条文は括弧書き＝「契約期間の始期の
    //   到来前のものを除く」・要件＝「契約期間を通算した期間（…通算契約期間…）が五年を超える」。
    const tenkan = rodoKeiyakuHo.find((a) => a.articleNum === "第18条");
    expect(tenkan?.text.includes("契約期間の始期の到来前のものを除く")).toBe(true);
    expect(
      tenkan?.text.includes("契約期間を通算した期間（次項において「通算契約期間」という。）が五年を超える"),
    ).toBe(true);
    // 旧・誤記の括弧書きが再混入していない
    expect(tenkan?.text.includes("契約期間の合計が五年を超えるものに限る")).toBe(false);
    // ⑤安全配慮義務条（第5条）の本文が「必要な配慮」を含む現行条文であること
    const anzen = rodoKeiyakuHo.find((a) => a.articleNum === "第5条");
    expect(anzen?.text.includes("生命、身体等の安全を確保しつつ")).toBe(true);
  });

  // 柱1（年少者則）是正の再発防止（旧コーパスは第7条⇄第8条の内容取り違え・第2条の架空見出しだった）
  it("既知の誤割当が再発していない（年少者則）", () => {
    const n = OFFICIAL_CAPTIONS_NENSHA_KISOKU;
    // 第7条＝重量物を取り扱う業務／第8条＝年少者の就業制限の業務の範囲（危険業務）。旧コーパスはこの2条を取り違えていた
    expect(n["第7条"]).toBe("重量物を取り扱う業務");
    expect(n["第8条"]).toBe("年少者の就業制限の業務の範囲");
    // 第4条・第6条は削除条文（コーパスに存在してはならない）
    expect(n["第4条"]).toBe("削除");
    expect(n["第6条"]).toBe("削除");
    // 重量物(第7条)＝法62条1項・危険業務列挙(ボイラー・クレーン等)＝第8条 の本文帰属を固定
    const juryo = nenshaRodoKijunKisoku.find((a) => a.articleNum === "第7条");
    expect(juryo?.articleTitle).toBe("重量物を取り扱う業務");
    expect(juryo?.text.includes("重量物を取り扱う業務")).toBe(true);
    const kiken = nenshaRodoKijunKisoku.find((a) => a.articleNum === "第8条");
    expect(kiken?.text.includes("ボイラー")).toBe(true);
    expect(kiken?.text.includes("クレーン、デリック又は揚貨装置の運転の業務")).toBe(true);
    // 旧コーパスの第2条「深夜業に従事させてはならない業務」は年少者則に実在しない見出し。
    // 深夜業関連は実在する第5条（交替制による深夜業の許可申請）へ是正済み
    expect(n["第5条"]).toBe("交替制による深夜業の許可申請");
    expect(nenshaRodoKijunKisoku.some((a) => a.articleNum === "第2条")).toBe(false);
    expect(Object.values(n).includes("深夜業に従事させてはならない業務")).toBe(false);
  });

  // 柱1（パート有期法）是正の再発防止（旧コーパスは第14条を非公式ラベル「給与等の説明」で収録していた）
  it("既知の誤割当が再発していない（パート有期法）", () => {
    const p = OFFICIAL_CAPTIONS_PATO_YUKI_HO;
    // ①目的＝第1条／②不合理な待遇の禁止＝第8条／③事業主が講ずる措置の内容等の説明＝第14条（いずれも実在条・公式見出し）
    expect(p["第1条"]).toBe("目的");
    expect(p["第8条"]).toBe("不合理な待遇の禁止");
    expect(p["第14条"]).toBe("事業主が講ずる措置の内容等の説明");
    // ④第14条 articleTitle の正本化: 旧コーパスの非公式ラベル「給与等の説明」が再混入していない
    const setsumei = tankiRodoShaKanriHo.find((a) => a.articleNum === "第14条");
    expect(setsumei?.articleTitle).toBe("事業主が講ずる措置の内容等の説明");
    expect(tankiRodoShaKanriHo.some((a) => a.articleTitle === "給与等の説明")).toBe(false);
    // ⑤第14条本文が雇入れ時説明（第1項）だけでなく待遇差説明（第2項）まで含む現行条文であること
    expect(
      setsumei?.text.includes("待遇の相違の内容及び理由"),
    ).toBe(true);
    expect(setsumei?.text.includes("求めがあったとき")).toBe(true);
    // ⑥第1条本文が現行の「短時間・有期雇用労働者」表記・「福祉の増進」であること（旧「福祉の向上」等の独自表現でない）
    const mokuteki = tankiRodoShaKanriHo.find((a) => a.articleNum === "第1条");
    expect(mokuteki?.text.includes("その福祉の増進を図り")).toBe(true);
    expect(mokuteki?.text.includes("福祉の向上を図り")).toBe(false);
    // 第8条は本文まで公式と完全一致（実在条・公式見出しで不変）
    expect(
      tankiRodoShaKanriHo.find((a) => a.articleNum === "第8条")?.text.includes(
        "不合理と認められる相違を設けてはならない",
      ),
    ).toBe(true);
  });

  // 柱1（職能法）是正の再発防止（旧コーパスは第10条の3「事業主の責務」・第15条の6「技能検定」の誤割当だった）
  it("既知の誤割当が再発していない（職能法）", () => {
    const s = OFFICIAL_CAPTIONS_SHOKUNO;
    // ①事業主の責務＝第4条「関係者の責務」（第10条の3はキャリアコンサルティング等の措置条で別条）。
    expect(s["第4条"]).toBe("関係者の責務");
    expect(s["第10条の3"]).toBe("事業主等の行う職業能力開発促進の措置*"); // 見出し無し条（第一節継承）
    const sekimu = shokugyoNoryokuKaihatsuSokushinHo.find((a) => a.articleNum === "第4条第1項");
    expect(sekimu?.articleTitle).toBe("関係者の責務");
    expect(sekimu?.text.includes("職業能力の開発及び向上の促進に努めなければならない")).toBe(true);
    // 旧・誤割当の第10条の3をコーパスが参照していないこと
    expect(shokugyoNoryokuKaihatsuSokushinHo.some((a) => a.articleNum === "第10条の3")).toBe(false);
    // ②技能検定＝第44条（第15条の6は職業に必要な技能に関する広報啓発等で別条）。
    expect(s["第44条"]).toBe("技能検定");
    expect(s["第15条の6"]).toBe("職業に必要な技能に関する広報啓発等");
    const ginou = shokugyoNoryokuKaihatsuSokushinHo.find((a) => a.articleNum === "第44条");
    expect(ginou?.text.includes("検定職種")).toBe(true);
    expect(ginou?.text.includes("実技試験及び学科試験")).toBe(true);
    expect(shokugyoNoryokuKaihatsuSokushinHo.some((a) => a.articleNum === "第15条の6")).toBe(false);
    // ③第1条（目的）本文が現行「労働施策の総合的な推進…に関する法律…と相まつて」へ是正され旧「雇用対策法」を含まないこと
    const mokuteki = shokugyoNoryokuKaihatsuSokushinHo.find((a) => a.articleNum === "第1条");
    expect(mokuteki?.text.includes("労働施策の総合的な推進")).toBe(true);
    expect(mokuteki?.text.includes("雇用対策法")).toBe(false);
    // ④第42条の7は削除条文（コーパスに存在してはならない）
    expect(s["第42条の7"]).toBe("削除");
  });

  // 柱1（最賃法）是正の再発防止（旧コーパスは第9条を「地域別最低賃金の決定」と誤記し第10条本文を接ぎ木していた）
  it("既知の誤割当が再発していない（最賃法）", () => {
    const s = OFFICIAL_CAPTIONS_SAITEI_CHINGIN_HO;
    // 第9条＝地域別最低賃金の原則（生計費・賃金支払能力の考慮）／第10条＝地域別最低賃金の決定（審議会）。旧コーパスはこの2条を混同していた
    expect(s["第9条"]).toBe("地域別最低賃金の原則");
    expect(s["第10条"]).toBe("地域別最低賃金の決定");
    // 第9条は原則条＝考慮要素・生活保護整合。旧本文の第10条第1項（審議会の意見を聴いて決定）を含まない
    const gensoku = saiteiChinginHo.find((a) => a.articleNum === "第9条");
    expect(gensoku?.articleTitle).toBe("地域別最低賃金の原則");
    expect(gensoku?.text.includes("生計費及び賃金並びに通常の事業の賃金支払能力を考慮")).toBe(true);
    expect(gensoku?.text.includes("生活保護に係る施策との整合性")).toBe(true);
    expect(gensoku?.text.includes("最低賃金審議会の調査審議を求め")).toBe(false);
    // 第10条は決定手続条＝審議会の意見を聴いて厚労大臣/労働局長が決定
    const kettei = saiteiChinginHo.find((a) => a.articleNum === "第10条");
    expect(kettei?.text.includes("最低賃金審議会")).toBe(true);
    expect(kettei?.text.includes("地域別最低賃金の決定をしなければならない")).toBe(true);
    // 第4条（最低賃金の効力）は正条・公式見出し一致で不変
    expect(s["第4条"]).toBe("最低賃金の効力");
  });

  // 柱1（労基則）是正の再発防止（旧コーパスはフレックスを第24条の2の2・割増賃金を第35条に誤割当していた）
  it("既知の誤割当が再発していない（労基則）", () => {
    const s = OFFICIAL_CAPTIONS_RODO_KIJUN_SOKO;
    // ①フレックスタイム制＝第12条の3。旧・誤割当先の第24条の2の2は現行では専門業務型裁量労働制
    expect(s["第12条の3"]).toBe("フレックスタイム制");
    expect(s["第24条の2の2"]).toBe("専門業務型裁量労働制");
    const flex = rodoKijunHoSikokiregu.find((a) => a.articleNum === "第12条の3");
    expect(flex?.articleTitle).toBe("フレックスタイム制");
    expect(flex?.text.includes("清算期間")).toBe(true);
    expect(flex?.text.includes("コアタイム")).toBe(true);
    // コーパスがフレックスを第24条の2の2で参照していないこと（誤割当の再発防止）
    expect(rodoKijunHoSikokiregu.some((a) => a.articleNum === "第24条の2の2")).toBe(false);
    // ②割増賃金の基礎＝第19条。旧・誤割当先の第35条は現行では業務上の疾病（法75条2項・別表第一の二）
    expect(s["第19条"]).toBe("割増賃金の基礎となる賃金");
    expect(s["第35条"].startsWith("業務上の疾病")).toBe(true);
    const wari = rodoKijunHoSikokiregu.find((a) => a.articleNum === "第19条");
    expect(wari?.text.includes("通常の労働時間又は通常の労働日の賃金の計算額")).toBe(true);
    expect(wari?.text.includes("出来高払制")).toBe(true);
    // コーパスが割増賃金を第35条で参照していないこと（誤割当の再発防止）
    expect(rodoKijunHoSikokiregu.some((a) => a.articleNum === "第35条")).toBe(false);
    // ③第5条（労働条件の明示）は正条だが2024-04-01施行改正の追加事項（変更の範囲・更新上限）を含む現行本文であること
    expect(s["第5条"]).toBe("労働条件の明示");
    const meiji = rodoKijunHoSikokiregu.find((a) => a.articleNum === "第5条");
    expect(meiji?.text.includes("就業の場所及び従事すべき業務の変更の範囲")).toBe(true);
    expect(meiji?.text.includes("更新回数に上限")).toBe(true);
  });

  // 柱1（女性則）是正の再発防止（旧コーパスは本則3条すべてを系統的に誤割当していた）
  it("既知の誤割当が再発していない（女性則）", () => {
    const s = OFFICIAL_CAPTIONS_JOSEI_KISOKU;
    // ①第1条＝坑内業務の就業制限の範囲（法第64条の2第2号）。旧・架空の「目的」条ではない
    expect(s["第1条"]).toBe("坑内業務の就業制限の範囲");
    const dai1 = joseiRodoKijunKisoku.find((a) => a.articleNum === "第1条");
    expect(dai1?.articleTitle).toBe("坑内業務の就業制限の範囲");
    expect(dai1?.text.includes("法第64条の2第2号")).toBe(true);
    expect(dai1?.text.includes("掘削")).toBe(true);
    // 旧・架空の「目的」文言（女性の生理的特性に応じた…）がコーパスに残っていないこと
    expect(joseiRodoKijunKisoku.some((a) => a.text.includes("生理的特性に応じた"))).toBe(false);
    // ②第2条＝危険有害業務の就業制限の範囲等（法第64条の3第1項＝妊娠中の女性）。旧・根拠「法第65条第3項」ではない
    expect(s["第2条"]).toBe("危険有害業務の就業制限の範囲等");
    const dai2 = joseiRodoKijunKisoku.find((a) => a.articleNum === "第2条");
    expect(dai2?.articleTitle).toBe("危険有害業務の就業制限の範囲等");
    expect(dai2?.text.includes("法第64条の3第1項")).toBe(true);
    expect(dai2?.text.includes("法第65条第3項")).toBe(false);
    // 公式第2条第1号＝重量物（旧コーパスは第1号を「鉛」としていた）。満18歳以上は継続20kg/断続30kgが上限
    expect(dai2?.text.includes("重量物")).toBe(true);
    expect(dai2?.text.includes("断続30kg・継続20kg")).toBe(true);
    // ③第3条＝妊産婦以外の女性への準用規定（法第64条の3第2項＝第2条第1項第1号・第18号を準用）。公式見出しは無い
    expect(s["第3条"].endsWith("*")).toBe(true);
    const dai3 = joseiRodoKijunKisoku.find((a) => a.articleNum === "第3条");
    expect(dai3?.text.includes("法第64条の3第2項")).toBe(true);
    expect(dai3?.text.includes("準用")).toBe(true);
    expect(dai3?.text.includes("第18号")).toBe(true);
    // 第4条＝雇用環境・均等局調査員（本則の実在条＝スナップショットに収録）
    expect(s["第4条"]).toBe("雇用環境・均等局調査員");
  });

  // 柱1（労働施策総合推進法）インライン未検証法の e-Gov 昇格。是正（振替）は無く、
  // corpus 収録の第30条の2は実在条・公式見出しと整合。昇格の忠実性と主要事実を固定する。
  it("e-Gov 昇格が忠実である（労施法）", () => {
    const s = OFFICIAL_CAPTIONS_ROSHI_HO;
    // 本則全条（第1〜41条・枝番12件含め53キー）。削除条は無い
    expect(Object.keys(s).length).toBe(53);
    expect(Object.values(s).some((c) => c === "削除" || c === "削除*")).toBe(false);
    // 第30条の2＝パワハラ防止の雇用管理上の措置等（第30条の3＝国・事業主・労働者の責務と別条）
    expect(s["第30条の2"]).toBe("雇用管理上の措置等");
    expect(s["第30条の3"]).toBe("国、事業主及び労働者の責務");
    // 紛争解決系の枝番が実在（第30条の4〜8）＝存在しない条番号を割り当てない
    expect(s["第30条の4"]).toBe("紛争の解決の促進に関する特例");
    expect(s["第30条の8"]).toBe("厚生労働省令への委任");
    expect(s["第30条の9"]).toBeUndefined();
    // corpus 収録は第30条の2 1条のみ。articleNum が実在し、公式見出しを articleTitle が包含する
    const paw = corpusGapFillArticles.find(
      (a) => a.lawShort === "労施法" && a.articleNum === "第30条の2",
    );
    expect(paw).toBeDefined();
    expect(paw?.articleTitle.includes("雇用管理上の措置等")).toBe(true);
    // 本文＝第1項のパワハラ措置義務（優越的な関係を背景とした言動・雇用管理上必要な措置）
    expect(paw?.text.includes("優越的な関係を背景とした言動")).toBe(true);
    expect(paw?.text.includes("雇用管理上必要な措置")).toBe(true);
    // 施行時期の注記（大企業2020年6月／中小2022年4月）は現行制度と整合
    expect(paw?.text.includes("2020年6月")).toBe(true);
  });
});
