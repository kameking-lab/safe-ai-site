...
export const KEYWORD_LANDINGS: KeywordLanding[] = [
  ...
  },
  {
    ...
    title: "年次安全衛生計画ジェネレーター（建設業ほか業種別13種）｜無料・PDF出力",
    description:
      "建設業・製造業・運輸業・医療福祉ほか13業種×規模3段階の39テンプレートから年次安全衛生計画書を無料で自動生成。基本方針・重点目標・実施事項・月別スケジュール・関連法令まで網羅。PDF出力可。",
    h1: "年次安全衛生計画ジェネレーター（建設業ほか業種別）：無料で使える計画書テンプレート",
    lead: "「年次安全衛生計画ジェネレーター」は、建設業を筆頭に業種13種×規模3段階の39テンプレートから、基本方針・重点目標・実施事項・月別スケジュール・関連法令を含む年次安全衛生計画書を自動生成する無料ツールです。安衛法第10条・第12条・第18条で求められる安全衛生管理体制の年次計画運用を支援します。当ページでは作成手順・各項目の意味・カスタマイズの考え方を解説します。",
    ...
    longTail: [
      ...
      },
      {
        ...
        answer:
          "建設業を筆頭に、製造業、運輸交通業（陸上貨物・倉庫含む）、医療・福祉、サービス業、小売業、飲食業、卸売業、倉庫・運送取扱業、事務系（情報通信・金融・士業ほか）、農業、林業、漁業の13業種に対応しています。それぞれの業種で代表的な事故型（建設業=墜落・転落、製造業=はさまれ・巻き込まれ、運輸業=荷役・道路、医療福祉=腰痛・転倒、サービス業=転倒・対人、農林漁業=機械・転倒・自然外力）に対応した重点目標と実施事項が雛形に組み込まれています。",
      },
      {
        query: "規模3段階とは — 何が変わる？",
        answer:
    ...
    related: [
      {
        ...
        description: "建設業を筆頭に業種13種×規模3段階の39テンプレートを実行",
      },
      {
        href: "/laws",
        label: "労働安全衛生法 条文一覧",
