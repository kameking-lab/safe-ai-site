...
export const KEYWORD_LANDINGS: KeywordLanding[] = [
  {
    ...
    description:
      "安衛法AIチャットボットの仕組み・対応法令・精度評価を解説。労働安全衛生法/安衛則/特化則など33法令以上を一次出典付きで即答する無料ツールの使い方と検索意図別の活用例。",
    h1: "安衛法AIチャットボットとは：無料で使える労働安全衛生法の質問AI",
    lead: "「安衛法AIチャットボット」は、労働安全衛生法・労働安全衛生規則・特定化学物質障害予防規則など33法令以上の条文をRAG検索し、質問に対して根拠条文付きで回答する無料のAIアシスタントです。当ページでは仕組み・対応範囲・精度評価・限界をまとめ、実際に使えるチャット画面へ案内します。",
    toolHref: "/chatbot",
    ...
    longTail: [
      {
        ...
        answer:
          "労働安全衛生法（安衛法）・労働安全衛生規則（安衛則）・有機溶剤中毒予防規則・特定化学物質障害予防規則・粉じん障害防止規則・酸素欠乏症等防止規則・じん肺法・石綿障害予防規則など33法令以上を対象に、RAG（検索拡張生成）方式で根拠条文を引きながら回答するAIです。e-Gov公開条文と厚労省通達を一次ソースとし、回答ごとに『この回答は安衛則第○条に基づく』の出典表示を行います。一般的な汎用ChatGPTと異なり、出典が法令本文に紐づくため『どの条文を根拠に答えているか』を読者が検証できます。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則、特定化学物質障害予防規則、有機溶剤中毒予防規則、鉛中毒予防規則、四アルキル鉛中毒予防規則、粉じん障害防止規則、酸素欠乏症等防止規則、電離放射線障害防止規則、高気圧作業安全衛生規則、事務所衛生基準規則、じん肺法、じん肺法施行規則、石綿障害予防規則、ボイラー及び圧力容器安全規則、クレーン等安全規則、ゴンドラ安全規則、機械等貸与者等の講ずべき措置、機械等検定規則、化学物質取扱事業者向け関連通達など33法令以上を収録しています。最新の収録法令一覧は/about/data-sourcesに公開しています。",
      },
      {
  ...
  },
  {
    ...
    title: "年次安全衛生計画ジェネレーター（業種別10種）｜無料・PDF出力",
    description:
      "建設業・製造業・運輸業・医療福祉ほか10業種×規模3段階の30テンプレートから年次安全衛生計画書を無料で自動生成。基本方針・重点目標・実施事項・月別スケジュール・関連法令まで網羅。PDF出力可。",
    h1: "年次安全衛生計画ジェネレーター（業種別）：無料で使える計画書テンプレート",
    lead: "「年次安全衛生計画ジェネレーター」は、業種10種×規模3段階の30テンプレートから、基本方針・重点目標・実施事項・月別スケジュール・関連法令を含む年次安全衛生計画書を自動生成する無料ツールです。安衛法第10条・第12条・第18条で求められる安全衛生管理体制の年次計画運用を支援します。当ページでは作成手順・各項目の意味・カスタマイズの考え方を解説します。",
    ...
    longTail: [
      ...
      {
        query: "対応する業種は10種類 — 具体的に何が選べる？",
        answer:
          "建設業、製造業、運輸業（陸上貨物・倉庫含む）、医療福祉、サービス業、小売業、飲食業、卸売業、倉庫業、事務系オフィスの10業種に対応しています。それぞれの業種で代表的な事故型（建設業=墜落・転落、製造業=はさまれ・巻き込まれ、運輸業=荷役・道路、医療福祉=腰痛・転倒、サービス業=転倒・対人）に対応した重点目標と実施事項が雛形に組み込まれています。",
      },
      {
        query: "規模3段階とは — 何が変わる？",
        answer:
      ...
      },
      {
        ...
        answer:
          "公的団体（JISHA等）が配布するWord/PDFテンプレートは（a）業種共通、（b）規模区分なし、（c）法改正反映が手作業、という運用上の課題があります。本ジェネレーターは（a）業種×規模の30パターン、（b）月別スケジュール自動配置、（c）安衛則・特化則の関連条文自動掲載、（d）全国安全週間等の年次イベント自動反映、により雛形の質と運用効率を高めています。",
      },
    ],
    steps: [
      {
        name: "業種と規模を選択",
        text: "/strategy/plan-generatorで業種（10種）と規模（小・中・大）を選びます。30の組み合わせから自社に近いテンプレートが選ばれます。",
        url: "/strategy/plan-generator",
      },
      {
        name: "雛形を生成・確認",
    ...
    related: [
      {
        ...
        description: "業種10種×規模3段階の30テンプレートを実行",
      },
      {
        href: "/laws",
        label: "労働安全衛生法 条文一覧",
