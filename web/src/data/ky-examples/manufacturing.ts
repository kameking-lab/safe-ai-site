...
export const MANUFACTURING_EXAMPLES: KyExample[] = [
  ...
  // ── 重量物運搬 (heavy-load) × 3 ────────────────────────────
  {
    ...
    hazards: ["重量物の腰部負荷", "金型角部での挟まれ", "床面の油分による滑り"],
    risks: ["腰痛・ヘルニア", "手指の挟まれ・打撲"],
    countermeasures: [
  ...
  },
  {
    ...
    hazards: ["ドラム缶転倒", "中身が漏出し滑りの原因に", "ラック上から落下"],
    risks: ["下肢の挟まれ・骨折", "化学物質曝露"],
    countermeasures: [
  ...
  // ── 機械操作 (machine) × 3 ─────────────────────────────────
  {
    ...
    hazards: ["手指の金型内挿入", "安全装置の機能不全", "材料送り時の挟まれ"],
    risks: ["手指の切断・潰挫", "上肢の重大障害"],
    countermeasures: [
  ...
  // ── 化学物質取扱 (chemical) × 3 ────────────────────────────
  {
    ...
    hazards: ["有機溶剤蒸気の吸入", "ミスト・粉じんの曝露", "静電気による引火"],
    risks: ["有機溶剤中毒", "塗装ミストによる呼吸器障害", "火災・爆発"],
    countermeasures: [
      "塗装ブースの局所排気装置を定期点検",
  ...
  },
  {
    ...
    hazards: ["薬液の飛散・吸入", "酸とアルカリの誤混合", "容器転倒"],
    risks: ["化学熱傷・失明", "有害ガス発生（塩素・アンモニア等）"],
    countermeasures: [
      "保護メガネ・耐薬品手袋・前掛けを着用",
      "酸とアルカリは別保管・別作業エリア",
      "希釈は『水に薬を加える』手順を厳守",
  ...
  },
  {
    ...
    hazards: ["SDS未確認での取扱い", "保管区分の誤り", "皮膚接触"],
    risks: ["発がん・皮膚障害", "保管中の事故"],
    countermeasures: [
  ...
  // ── フォークリフト (forklift) × 3 ──────────────────────────
  {
    ...
    hazards: ["歩行者導線との交差", "急なバック走行", "曲がり角での見通し不良"],
    risks: ["歩行者との衝突・轢過", "他設備との接触"],
    countermeasures: [
      "歩車分離レーンを白線で明示",
      "曲がり角にミラー・回転灯感知センサ設置",
      "場内制限速度8km/h以下",
  ...
  },
  {
    ...
    hazards: ["ドックレベラー段差での転落", "車両逸走", "荷物の重心ずれ"],
  ...
  },
  {
    ...
    hazards: ["高揚高での視界喪失", "棚への接触で棚崩壊", "荷の落下"],
    risks: ["棚倒壊による下方被災", "荷崩れ"],
    countermeasures: [
  ...
  // ── 掘削 (excavation) × 3 ──────────────────────────────────
  {
    ...
    hazards: ["既設配管・電線の損傷", "土砂崩壊", "降雨での冠水"],
    risks: ["停電・断水・操業停止", "作業員の埋没"],
    countermeasures: [
      "工場図面と探査機で埋設物を事前確認",
      "深さ1.5m超は土止め支保工を設置",
  ...
  // ── 溶接 (welding) × 3 ─────────────────────────────────────
  {
    ...
    workType: "welding",
    title: "鉄骨製品のCO2半自動溶接",
    hazards: ["ヒューム吸入", "アーク光眼障害", "スパッタによる火災"],
    risks: ["じん肺・肺がん", "電気性眼炎", "周辺火災"],
    countermeasures: [
  ...
  },
  {
    ...
    workType: "welding",
    title: "ステンレス配管のTIG溶接",
    hazards: ["クロムを含むヒューム発生", "オゾン発生", "アーク光"],
    risks: ["クロム障害・がん", "気管支炎"],
    countermeasures: [
      "局所排気フードを溶接位置に追従配置",
  ...
  // ── 玉掛け (rigging) × 3 ───────────────────────────────────
  {
    ...
    workType: "rigging",
    title: "鋳物製品の天井クレーン搬出",
    hazards: ["鋳物の鋭利エッジでのワイヤー損傷", "重心ずれ", "高温部の残熱"],
    risks: ["ワイヤー破断による落下", "火傷"],
    countermeasures: [
      "鋭利エッジに当て物を挟みワイヤー保護",
      "重心マーキングと専用治具を使用",
  ...
  },
  {
    ...
    hazards: ["金型重量が定格超過", "つり点の摩耗", "高さ調整時の挟まれ"],
    risks: ["落下事故", "挟まれ災害"],
    countermeasures: [
      "金型重量表示と定格荷重照合",
      "つり点（アイボルト等）の摩耗・ねじ確認",
  ...
  },
  {
    ...
    workType: "other",
    title: "工場内の騒音区域での作業",
    hazards: ["85dB超の連続騒音", "耳栓不着用", "警報音聞き逃し"],
    risks: ["騒音性難聴", "緊急警報の見落とし"],
    countermeasures: [
