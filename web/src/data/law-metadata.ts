...
export const LAW_METADATA: Record<string, LawMetadata> = {
  ...
  年少者則: {
    ...
    egovLawId: "329M50002000013",
  },
  // ── 法令ナビ カバレッジ拡大（2026-07-11）: 以下は e-Gov API v2 で law_id・現行有効
  // （repeal_status=None）・法令名一致を機械突合して追加。指針・ガイドライン・通達・
  ...
  過労死防止法: {
    ...
    issuer: "厚生労働省",
    enactedOn: "平成26年6月27日公布・平成26年11月1日施行",
  ...
  健康増進法: {
    ...
    fullName: "健康増進法",
    issuer: "厚生労働省",
    enactedOn: "平成14年8月2日公布・平成15年5月1日施行",
