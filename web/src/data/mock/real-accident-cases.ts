...
export const realAccidentCases: AccidentCase[] = [
  {
    id: "mhlw-100003",
    title: "松の木剪定中に脚立8段目（高さ約2.3m）から転落",
    occurredOn: "2007-03-15",
    type: "墜落",
    workCategory: "その他の事業",
    severity: "死亡",
    summary:
      "個人住宅の松の木（上部は高さ約3.7〜5.0m）を剪定後、脚立8段目付近（高さ約2.3m）から下りる際にバランスを崩し、コンクリート通路上へ転落。出典: anzeninfo.mhlw.go.jp/anzen_pg/SAI_DET.aspx?joho_no=100003",
    mainCauses: [
      "高さ約2.3mで剪定していたが、安全帯を松の木へ取り付けるなどの墜落防止措置を講じていなかった",
      "コンクリート通路上での作業にもかかわらず保護帽を着用していなかった",
      "作業中の安全指示が徹底されていなかった",
    ],
    preventionPoints: [
      "高さ2m以上では安衛則第518条に基づき作業床を設け、困難な場合は防網または要求性能墜落制止用器具等による墜落防止措置を講じる",
      "脚立上の作業・昇降では保護帽を着用し、足元を確認して慎重に昇降する",
      "樹木剪定の安全作業手順を定め、手順に従うよう教育する",
    ],
    source: {
      site: "職場のあんぜんサイト",
      caseId: "100003",
  ...
  {
    id: "mhlw-100620",
    title: "休憩時間に吊り足場を移動中、川に墜落",
    occurredOn: "発生日非公表",
    type: "墜落",
    workCategory: "建設業",
    severity: "死亡",
    summary:
      "橋梁塗装工事用の吊り足場を解体中、防網を撤去した足場上で休憩していた作業者が川へ墜落し、溺死した。厚生労働省『職場のあんぜんサイト』No.100620 の発生状況・原因・対策と照合済み。",
    mainCauses: [
      "墜落危険箇所に親綱等を設けず、安全帯を使用させていなかった",
      "経験のない18歳未満の作業者を足場解体作業に従事させた",
      "作業計画、統括安全管理、作業主任者による監視が不十分だった",
    ],
    preventionPoints: [
      "作業時と移動時に使用できる親綱等を設け、墜落制止用器具を確実に使用する",
      "18歳未満の者を足場の解体・変更作業に従事させない",
      "作業計画と連絡調整を行い、作業主任者が配置・保護具使用を監視する",
    ],
    industry_detail: "橋梁建設工事業",
    source: {
      site: "職場のあんぜんサイト",
      caseId: "100620",
