...
export const realLawRevisionsExtra: LawRevisionCore[] = [
  ...
  },
  {
    ...
    title: "カスタマーハラスメント防止措置の事業主義務化（労働施策総合推進法改正）",
    publishedAt: "2025-06-11",
    revisionNumber: "令和7年法律第63号",
    kind: "law",
    category: "労働施策総合推進法",
    issuer: "厚生労働省",
    summary: "令和7年6月11日公布の改正法により、職場におけるカスタマーハラスメント防止のための雇用管理上の措置が事業主の義務となる。施行日は2026年10月1日。具体的な措置は令和8年厚生労働省告示第51号の指針も確認する。",
    source: { url: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/koyou_roudou/koyoukintou/seisaku06/", label: "厚生労働省 ハラスメント防止" },
    official_notice_number: "令和7年法律第63号",
