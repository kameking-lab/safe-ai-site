...
export const STRESS_CHECK_REQUIREMENTS: StressCheckRequirement[] = [
  ...
  },
  {
    ...
    ruleArticles: ["労安衛則 第52条の17・第52条の18"],
    appliesTo: ["mandatory", "effort-duty"],
    baseline: true,
  },
  {
  ...
  },
  {
    ...
    ruleArticles: ["労安衛法 第66条の10 第三項", "労安衛則 第52条の21"],
    appliesTo: ["mandatory", "effort-duty"],
    baseline: true,
  },
  {
    ...
    ruleArticles: ["労安衛則 第52条の13・第52条の18"],
    appliesTo: ["mandatory", "effort-duty"],
    baseline: true,
  },
  {
