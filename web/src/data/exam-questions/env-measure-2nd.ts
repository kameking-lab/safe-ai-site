...
export const questions: ExamQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: "イ",
    explanation:
      "作業環境評価基準第4条・安衛法第65条の2により、第3管理区分では直ちに施設・設備の改善、改善されるまでの呼吸用保護具の使用、作業環境管理専門家への相談等が必要。",
    relatedLaw: "作業環境評価基準第4条",
  },
  {
    id: "em2-law-2023-004",
  ...
  },
  {
    ...
    correctAnswer: "イ",
    explanation:
      "安衛法第65条の2により、評価結果（管理区分）に応じた適切な措置が必要。第1は維持・向上、第2は自主的改善、第3は直ちに改善措置と呼吸用保護具の使用が義務。",
