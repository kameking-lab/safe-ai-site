...
export const OVERTIME_CHECKUP_RULES: CheckupRule[] = [
  {
    ...
    notes: [
      ...
      "研究開発業務従事者は月100時間超で本人申出なしでも面接指導が義務（労安法第66条の8の2）。",
      "高度プロフェッショナル制度対象労働者は健康管理時間が1週間あたり40時間を超えた時間が月100時間を超えた場合に本人申出なしで面接指導が義務（労安法第66条の8の4）。",
      "労働時間状況の客観的把握（PC ログオン記録等）が前提（労安法第66条の8の3、平成31年4月施行）。",
    ],
  },
];
