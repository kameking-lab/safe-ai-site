 ...
 * トピック → 関連法令カテゴリのマッピング。
 *
 * ペルソナテスト失敗11件を完全カバーしつつ、頻出 50法令外トピックを 50件超 登録。
  ...
  return {
    ...
    headline:
      matches.length > 0
        ...
        : "本ツールの提供データ範囲（50法令＋関連通達）では確証ある回答が得られませんでした。",
    egovFooter:
