...
export const RAG_100_QUESTIONS: RagTestCase[] = [
  ...
  { id: 27, topic: "健診", question: "有機溶剤健康診断はどの則の何条？", gold: [{ lawShort: "有機則", articleNum: "第29条" }, { lawShort: "有機則", articleNum: "第30条" }] },
  ...
  // E. クレーン・揚重機 (41-48)
  { id: 41, topic: "クレーン", question: "クレーン定期自主検査の頻度は？", gold: [{ lawShort: "クレーン則", articleNum: "第34条" }, { lawShort: "クレーン則", articleNum: "第35条" }] },
  { id: 42, topic: "クレーン", question: "クレーン運転の資格は？", gold: [{ lawShort: "クレーン則", articleNum: "第22条" }, { lawShort: "クレーン則", articleNum: "第68条" }] },
  ...
  { id: 48, topic: "クレーン", question: "クレーンの検査証の有効期間は？", gold: [{ lawShort: "クレーン則", articleNum: "第10条" }, { lawShort: "クレーン則", articleNum: "第9条" }, { lawShort: "クレーン則", articleNum: "第40条" }] },
  ...
  { id: 51, topic: "局排", question: "局所排気装置の性能要件は？", gold: [{ lawShort: "特化則", articleNum: "第7条" }, { lawShort: "有機則", articleNum: "第5条" }, { lawShort: "有機則", articleNum: "第20条" }] },
