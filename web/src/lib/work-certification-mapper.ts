...
export const WORK_SCENARIOS: WorkScenario[] = [
  ...
  },
  {
    ...
    category: "general",
    requiredCertIds: ["se-36-15-gondola", "se-36-41-harness"],
    legalNote: "安衛則第36条第15号（ゴンドラ特別教育）＋第41号（フルハーネス）",
  },
  {
    id: "ws-koshosha",
    label: "高所作業車の運転",
    ...
    category: "construction",
    requiredCertIds: ["se-36-14-high-lift", "st-high-lift"],
    legalNote: "作業床高さ10m未満は特別教育（安衛則第36条第14号）、10m以上は技能講習（安衛令第20条第15号）",
  },
  // ===== クレーン・玉掛け =====
  {
    id: "ws-crane-small",
    ...
    requiredCertIds: ["se-36-5-jukiso"],
    legalNote: "安衛則第36条第5号 — 5t以上は技能講習または免許が必要",
  },
  {
    id: "ws-crane-large",
  ...
  },
  {
    ...
    category: "construction",
    requiredCertIds: ["se-36-6-ido-crane", "st-mobile-crane", "lic-mobile-crane"],
  ...
  // ===== フォークリフト・建設機械 =====
  {
    ...
    category: "logistics",
    requiredCertIds: ["se-36-9-shovelloader", "st-forklift"],
    legalNote: "最大荷重1t未満は特別教育（安衛則第36条第5号相当）、1t以上は技能講習（安衛令第20条第11号）",
  },
  {
    id: "ws-shovel-large",
  ...
  },
  {
    ...
    category: "construction",
    requiredCertIds: ["se-36-10-shovel"],
  ...
  // ===== 掘削・土木 =====
  {
    ...
    category: "construction",
    requiredCertIds: ["st-excavation-chief", "se-36-35-chijoushi", "se-36-36-tobari"],
    legalNote: "安衛令第6条第9号 — 掘削作業主任者（技能講習）の選任必須。2m未満は特別教育のみ",
  },
  {
    id: "ws-tunnel",
    ...
    category: "construction",
    requiredCertIds: ["se-36-37-tunneling", "st-tunnel-chief", "st-tunnel-lining-chief"],
    legalNote: "安衛則第36条第37号（特別教育）＋安衛令第6条第11号・11号の2（作業主任者2種）",
  },
  {
    ...
    category: "construction",
    requiredCertIds: ["se-36-29-asbestos", "st-asbestos-chief"],
    legalNote: "安衛則第36条第29号（特別教育）＋安衛令第6条第23号（石綿作業主任者）",
  },
  // ===== 電気 =====
  {
    id: "ws-teiatsu",
    ...
    legalNote: "安衛則第36条第4号 — 低圧電気取扱い特別教育（充電電路は14h以上）",
  },
  {
    id: "ws-koatsu",
    ...
    category: "electrical",
    requiredCertIds: ["se-36-4-2-koatsu"],
    legalNote: "安衛則第36条第4号の2 — 高圧・特別高圧電気取扱い特別教育（12h以上）",
  },
  // ===== 溶接・ガス =====
  {
    id: "ws-arc-welding",
    ...
    legalNote: "安衛則第36条第3号 — アーク溶接等特別教育（11h以上）",
  },
  {
    id: "ws-gas-welding",
    label: "ガス溶接・ガス切断作業",
  ...
  // ===== 有害物・化学 =====
  {
    ...
    category: "manufacturing",
    requiredCertIds: ["se-36-22-yuki", "st-yuki-chief"],
    legalNote: "安衛則第36条第22号（特別教育）＋安衛令第6条第22号（有機溶剤作業主任者）",
  },
  {
    id: "ws-sanketo",
  ...
  },
  {
    ...
    category: "chemical",
    requiredCertIds: ["se-36-21-tokushu", "st-tokuka-chief"],
    legalNote: "安衛則第36条第21号（特別教育）＋安衛令第6条第18号（特化物作業主任者）",
  },
  // ===== 林業 =====
  {
    id: "ws-chainsaw",
    ...
    category: "forestry",
    requiredCertIds: ["se-36-36a-karaki"],
    legalNote: "安衛則第36条第8号の2 — 伐木等（チェーンソー使用）特別教育（20h以上）",
  },
  // ===== 放射線 =====
  {
    id: "ws-xray",
    ...
    category: "manufacturing",
    requiredCertIds: ["se-36-23-radiation", "lic-xray-chief", "lic-gamma-chief"],
    legalNote: "安衛則第36条第23号（特別教育）＋作業主任者免許（X線・ガンマ線それぞれ）",
  },
  // ===== 潜水 =====
  {
    id: "ws-diving",
    ...
    category: "construction",
    requiredCertIds: ["se-36-25-shokucho2", "lic-diver"],
    legalNote: "安衛則第36条第25号（特別教育）＋安衛令第20条第9号（潜水士免許）",
  },
];
...
export const WORK_TAGS: WorkTag[] = [
  ...
  { id: "tag-crane", label: "クレーン", certIds: ["se-36-5-jukiso", "st-crane-5t", "lic-crane-derrick"] },
  { id: "tag-mobile-crane", label: "移動式クレーン", certIds: ["se-36-6-ido-crane", "st-mobile-crane", "lic-mobile-crane"] },
  { id: "tag-tamakake", label: "玉掛け", certIds: ["se-36-19-tamakake", "st-tamakake"] },
  { id: "tag-forklift", label: "フォークリフト", certIds: ["se-36-9-shovelloader", "st-forklift"] },
  { id: "tag-backhoe", label: "バックホー", certIds: ["se-36-10-shovel", "st-shovel"] },
  { id: "tag-asbestos", label: "石綿・アスベスト", certIds: ["se-36-29-asbestos", "st-asbestos-chief"] },
  { id: "tag-sanso", label: "酸素欠乏", certIds: ["se-36-26-shokucho-sanso", "st-sankesu-chief"] },
  { id: "tag-yuki", label: "有機溶剤", certIds: ["se-36-22-yuki", "st-yuki-chief"] },
  ...
  { id: "tag-koatsu", label: "高圧電気", certIds: ["se-36-4-2-koatsu"] },
  { id: "tag-chainsaw", label: "チェーンソー", certIds: ["se-36-36a-karaki"] },
  { id: "tag-koshosha", label: "高所作業車", certIds: ["se-36-14-high-lift", "st-high-lift"] },
  { id: "tag-gondola", label: "ゴンドラ", certIds: ["se-36-15-gondola"] },
  { id: "tag-diving", label: "潜水", certIds: ["se-36-25-shokucho2", "lic-diver"] },
  { id: "tag-xray", label: "X線・非破壊検査", certIds: ["se-36-23-radiation", "lic-xray-chief"] },
  { id: "tag-tokuka", label: "特定化学物質", certIds: ["se-36-21-tokushu", "st-tokuka-chief"] },
  { id: "tag-dust", label: "粉じん", certIds: ["se-36-28-saibai", "st-dust-chief"] },
  { id: "tag-tunnel", label: "トンネル", certIds: ["se-36-37-tunneling", "st-tunnel-chief", "st-tunnel-lining-chief"] },
