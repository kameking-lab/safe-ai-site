...
const LABELED_VALUE_PATTERNS: Array<[ChatbotSensitiveDataKind, RegExp]> = [
  ...
  [
    "name",
    /(?:担当者|責任者|作業員名?|作業者名?|講師|被災者|負傷者|死亡者|班長|現場代理人|連絡担当|作業主任者|作業指揮者|安全衛生責任者|電気主任技術者|主任技術者|監督者?|管理者|主任(?!者|技術者)|職長|所長)[は:：=]?(?!(?:未定|不明|匿名|なし|未記入|何人|何名|何条|何号|何を|どこ|いつ|必要|選任|教育|研修|講習|技能|特別|資格|職務|責務|制度|会議|作業|対象|業務|作業者[A-ZＡ-Ｚ]|作業員[A-ZＡ-Ｚ]))[一-龠々〆ヶ]{2,12}(?:です|さん|氏|様|君)?/,
  ],
  [
    "name",
...
export function detectChatbotSensitiveData(
  ...
  const safeSeparatedWorkCompound =
    /^(?:高圧・特別高圧|低圧・高圧|低圧・高圧・特別高圧)$/;
  const nonNameWorkValue =
    /安全|衛生|作業|業務|工事|現場|足場|脚立|作業台|設備|機械|器具|資格|教育|法令|法律|規則|規定|条文|建設|製造|運送|林業|鉱業|清掃|屋内|屋外|晴天|雨天|曇天|建築物|工作物|船舶|解体|改修|封じ込め|技能講習|特別教育|作業主任者|作業指揮者|管理者|事業者|事業主|労働者|作業者|担当者|責任者|監視人|調査者|運転者|合図者|誘導者|請負人|発注者|注文者|使用者|派遣先|派遣元|元方事業者|関係請負人|会社|企業|業者|被災者|負傷者|死亡者|雇用主|元請人|下請人|一人親方|監督者|現場代理人|職長|所長|班長|主任|社員|職員|従業員|同僚|本人|産業医|医師|保健師|厚生労働省|労働局|労働基準監督署|行政|所管省庁|第一種|第二種|第三種|有機溶剤|シンナー|酸欠|圧力容器|放射線|一般区域|製品名|通達|発出日|文書番号|墜落防止|委員会|粉じん|鉛|騒音|速度|設定|検査|点検|測定|盤内|配線|充電部|換気|保護具|保護措置|譲渡|提供|用途|荷重|未定|匿名|不明|未記入|なし/;
  ...
  const separatedName = spaced.match(
    /(?:^|[\s、。])([一-龠々〆ヶ]{1,5})[\s　・･]+([一-龠々〆ヶぁ-んァ-ヶー]{1,8})(?:$|[\s、。])/,
  );
  if (
    separatedName?.[1] &&
    separatedName[2] &&
    !safeSeparatedWorkCompound.test(compact) &&
    !nonNameWorkValue.test(separatedName[1]) &&
    !nonNameWorkValue.test(separatedName[2]) &&
    !nonNameWorkValue.test(`${separatedName[1]}${separatedName[2]}`)
  ) {
    kinds.add("name");
  }
