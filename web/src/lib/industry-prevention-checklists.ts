...
const MANUFACTURING: ChecklistItem[] = [
  ...
  { no: 7, category: "equipment", text: "コンベア・ロール機の囲い・覆い・非常停止スイッチが機能することを毎日確認している", basis: "労働安全衛生規則 第151条の82" },
  { no: 8, category: "equipment", text: "フォークリフト・無人搬送車（AGV）の通路は人作業エリアと色別ラインで区分している", basis: "労働安全衛生規則 第151条の3〜第151条の31" },
...
const TRANSPORT: ChecklistItem[] = [
  { no: 1, category: "high-risk-work", text: "荷役作業（トラック荷台・テールゲートリフター等）は安全衛生教育受講者を配置している", basis: "陸災防「荷役作業安全ガイドライン」/ 安衛則 第151条の70" },
  { no: 2, category: "high-risk-work", text: "高さ2m以上のトラック荷台での作業には昇降設備・墜落制止用器具を準備している", basis: "労働安全衛生規則 第151条の74" },
  { no: 3, category: "high-risk-work", text: "フォークリフト荷役は無資格者の運転を禁止し、合図者を配置している", basis: "労働安全衛生規則 第151条の3 / 安衛法 第61条" },
  ...
  { no: 7, category: "equipment", text: "テールゲートリフター使用時は積載重量と取扱手順を遵守している", basis: "労働安全衛生規則 第151条の20（2024年改正）" },
  { no: 8, category: "equipment", text: "フォークリフトのバックブザー・ヘッドガード・シートベルトを点検している", basis: "労働安全衛生規則 第151条の14" },
