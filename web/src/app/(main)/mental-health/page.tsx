...
const CASEHARA: InfoCard[] = [
  {
    title: "カスハラ防止措置の施行予定",
    body: "令和7年法律第63号は2025年6月11日に公布されました。職場におけるカスタマーハラスメント防止措置の事業主義務は2026年10月1日施行です。具体的な準備では、2026年2月26日公布の令和8年厚生労働省告示第51号と厚生労働省の最新案内を確認してください。",
    law: "労働施策総合推進法（令和7年法律第63号による改正・2026年10月1日施行）、令和8年厚生労働省告示第51号",
  },
  {
    title: "事業主が講ずべき措置（2026年10月1日適用の指針）",
    body: "指針は、①方針と対処内容の明確化・周知、②相談体制の整備、③事実確認・被害者への配慮・再発防止、④悪質事案を抑止する方針と体制、⑤プライバシー保護と不利益取扱いの禁止を示しています。業種ごとの法令・サービス提供義務、障害特性への合理的配慮にも留意が必要です。",
  },
  {
    title: "対象業種",
