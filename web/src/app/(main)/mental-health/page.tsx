...
const CASEHARA: InfoCard[] = [
  {
    title: "カスハラ対策の法制化",
    body: "労働施策総合推進法の改正により、2025年（令和7年）以降、カスタマーハラスメント（顧客等からの著しい迷惑行為）への事業者の対応措置が義務化の流れ。就業規則への規定・相談体制整備・被害者ケアが求められる。",
    law: "労働施策総合推進法（改正検討中）、パワハラ防止法（施行済）",
  },
  {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-6 sm:py-8">
      ...
      <p className="mt-8 text-center text-xs text-slate-400">
        最終更新：2026年4月。産業医・臨床心理士・社労士等の専門家との連携が前提です。
      </p>
    </main>
  );
}
