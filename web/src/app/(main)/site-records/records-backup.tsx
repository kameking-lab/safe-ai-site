  ...
  return (
    <section className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-4 print:hidden">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <button type="button" onClick={handleExport} className="inline-flex items-center gap-1 rounded-lg bg-emerald-600 min-h-[44px] px-3 py-2 text-xs font-bold text-white hover:bg-emerald-700">
          <Download className="h-3.5 w-3.5" aria-hidden="true" /> バックアップを書き出す
        </button>
        <button type="button" onClick={handleImportClick} className="inline-flex items-center gap-1 rounded-lg border border-slate-300 bg-white min-h-[44px] px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100">
