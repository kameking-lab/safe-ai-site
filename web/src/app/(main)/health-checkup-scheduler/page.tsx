...
const _title = "健康診断スケジューラ｜業種・職種別に必要な健診を自動判定";
const _desc =
  "業種・職種・取扱化学物質・作業条件から、一般健診・特定業務従事者健診・特殊健診・じん肺健診・歯科特殊健診・電離放射線健診の必要種別を自動判定し、雇入日を起点とした年間スケジュールを生成します。安衛則・有機則・特化則・鉛則・四アルキル鉛則・高気圧則・石綿則・じん肺法・電離則に対応。";
      ...
      <PageContainer width="prose" className="py-8 md:py-12">
        <header className="mb-6">
          ...
          <p className="mt-3 text-base text-slate-700">
            業種と職種、取扱化学物質、作業条件を選ぶだけで、労働安全衛生法・関係省令で求められる健康診断（一般健診／特定業務従事者健診／特殊健診／じん肺健診／歯科特殊健診／電離放射線健診）の必要種別を判定し、雇入日を起点にした年間スケジュールを生成します。
          </p>
          <ul className="mt-4 list-disc space-y-1 pl-6 text-sm text-slate-600">
            <li>建設業・製造業・運輸交通業・医療福祉・サービス業の代表的職種を網羅。</li>
            <li>有機則・特化則・鉛則・四アルキル鉛則・高気圧則・石綿則・じん肺法・電離則の各健診規定に対応。</li>
            <li>雇入日を入力すると、雇入時健診と6か月以内ごとの再実施月を自動配置。</li>
