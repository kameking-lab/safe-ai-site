...
const _desc =
  "業種・職種・取扱化学物質・作業条件から、一般健診・特定業務従事者健診・特殊健診（特化則の個別物質14種を含む）・じん肺健診・歯科特殊健診・電離放射線健診・長時間労働者の医師面接指導・海外派遣労働者健診の必要種別を自動判定し、雇入日を起点とした年間スケジュールを生成・繁忙期回避で最適化します。安衛則・有機則・特化則・鉛則・四アルキル鉛則・高気圧則・石綿則・じん肺法・電離則・労安法第66条の8/45条の2 に対応。";
      ...
      <PageContainer width="prose" className="py-8 md:py-12">
        <header className="mb-6">
          ...
          <ul className="mt-4 list-disc space-y-1 pl-6 text-sm text-slate-600">
            ...
            <li>労安法第66条の8 長時間労働者の医師面接指導と、安衛則第45条の2 海外派遣前後健診も判定対象。</li>
