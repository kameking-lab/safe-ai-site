...
const courseSchema = {
  ...
  name: "化学物質RA実務教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/hoteikyoiku/chemical-ra",
  timeRequired: "PT4H",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "化学物質RA実務教育", item: "https://www.anzen-ai-portal.jp/education/hoteikyoiku/chemical-ra" },
  ],
};
