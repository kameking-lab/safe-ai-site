...
const courseSchema = {
  ...
  name: "職長等教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/hoteikyoiku/shokucho",
  timeRequired: "PT12H",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "職長等教育", item: "https://www.anzen-ai-portal.jp/education/hoteikyoiku/shokucho" },
  ],
};
...
export default function ShokuchoPage() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <CourseConclusion
        kind="legal"
        duration="12時間以上（2日間想定）"
        basis="法律ベース"
        summary="安衛法第60条・安衛則第40条に基づく、指定業種の職長等を対象とする法定12時間以上の教育。"
      />
      ...
      <section className="rounded-2xl border border-sky-200 bg-gradient-to-br from-sky-50 to-white p-6">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-sky-700 px-5 py-2.5 min-h-[44px] text-sm font-bold text-white shadow-sm hover:bg-sky-800 transition-colors"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-sky-700 bg-white px-5 py-2.5 min-h-[44px] text-sm font-bold text-sky-800 hover:bg-sky-50 transition-colors"
          >
