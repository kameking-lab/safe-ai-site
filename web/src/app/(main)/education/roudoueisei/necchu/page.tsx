...
const courseSchema = {
  ...
  name: "熱中症予防 労働衛生教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/roudoueisei/necchu",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "熱中症予防 労働衛生教育", item: "https://www.anzen-ai-portal.jp/education/roudoueisei/necchu" },
  ],
};
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <CourseConclusion
        ...
        duration="約1.5時間"
        basis="通達ベース"
        summary="熱中症予防ガイドライン・2025年6月施行の安衛則改正に基づく、屋外/高温環境作業者向けの労働衛生教育。"
      />
      ...
      <EducationContextSections slug="roudoueisei/necchu" />
      ...
      <section className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-6">
        <p className="text-base font-bold text-emerald-900">熱中症予防教育のお問い合わせ・改善提案</p>
