...
const courseSchema = {
  ...
  name: "腰痛予防労働衛生教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/roudoueisei/youtsu-yobou",
  timeRequired: "PT2H",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "腰痛予防労働衛生教育", item: "https://www.anzen-ai-portal.jp/education/roudoueisei/youtsu-yobou" },
  ],
};
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <section className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-6">
        <p className="text-base font-bold text-emerald-900">腰痛予防教育のお問い合わせ・改善提案</p>
