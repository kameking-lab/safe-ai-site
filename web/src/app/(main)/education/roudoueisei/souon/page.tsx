...
const courseSchema = {
  ...
  name: "騒音障害防止 労働衛生教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/roudoueisei/souon",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "騒音障害防止 労働衛生教育", item: "https://www.anzen-ai-portal.jp/education/roudoueisei/souon" },
  ],
};
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <CourseConclusion
        ...
        duration="約1.5時間"
        basis="通達ベース"
        summary="騒音障害防止ガイドライン（基発0420第2号）に基づく、85dB以上の作業環境の作業者向け労働衛生教育。"
      />
      ...
      <EducationContextSections slug="roudoueisei/souon" />
      ...
      <section className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-6">
        <p className="text-base font-bold text-emerald-900">騒音障害防止教育のお問い合わせ・改善提案</p>
