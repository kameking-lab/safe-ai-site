...
const courseSchema = {
  ...
  name: "研削といし取替え等 特別教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/tokubetsu/kensaku-toishi",
  timeRequired: "PT4H",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "研削といし取替え等 特別教育", item: "https://www.anzen-ai-portal.jp/education/tokubetsu/kensaku-toishi" },
  ],
};
...
export default function KensakuToishiPage() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <CourseConclusion
        kind="special"
        duration="約4時間（学科2h+実技2h）"
        basis="省令ベース"
        summary="安衛則第36条第1号に基づく、研削といし取替え業務者向け特別教育（学科2h＋実技2h以上）。"
      />
      ...
      <EducationContextSections slug="tokubetsu/kensaku-toishi" />
      ...
      <section className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-6">
        <p className="text-base font-bold text-emerald-900">研削といし特別教育のお問い合わせ・改善提案</p>
