...
const courseSchema = {
  ...
  name: "低圧電気取扱い 特別教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/tokubetsu/teiatsu-denki",
  timeRequired: "PT7H",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "低圧電気取扱い 特別教育", item: "https://www.anzen-ai-portal.jp/education/tokubetsu/teiatsu-denki" },
  ],
};
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <section className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-6">
        <p className="text-base font-bold text-emerald-900">低圧電気特別教育のお問い合わせ・改善提案</p>
