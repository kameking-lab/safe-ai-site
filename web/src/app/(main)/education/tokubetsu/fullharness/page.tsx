...
const courseSchema = {
  ...
  description: DESCRIPTION,
  url: "https://anzen-ai-portal.jp/education/tokubetsu/fullharness",
  timeRequired: "PT6H",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "フルハーネス型墜落制止用器具 特別教育", item: "https://anzen-ai-portal.jp/education/tokubetsu/fullharness" },
  ],
};
