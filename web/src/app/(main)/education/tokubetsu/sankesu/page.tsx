...
const courseSchema = {
  ...
  name: "酸素欠乏危険作業 特別教育",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/tokubetsu/sankesu",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "酸素欠乏危険作業 特別教育", item: "https://www.anzen-ai-portal.jp/education/tokubetsu/sankesu" },
  ],
};
...
const FAQS = [
  ...
  {
    q: "監視員の常時配置は必要ですか？",
    a: "酸素欠乏症等防止規則第13条（監視人等）に基づき、酸素欠乏危険作業中の監視人配置は必須です。入槽者と槽外で常時連絡を取り、異常時に即座に救助手順を開始できる体制を整備してください。",
  },
];
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <CourseConclusion
        ...
        duration="約5.5時間"
        basis="規則ベース"
        summary="酸素欠乏症等防止規則第12条に基づく、酸欠危険場所の作業者向け特別教育（第一種・第二種）。"
      />
      ...
      <EducationContextSections slug="tokubetsu/sankesu" />
      ...
      <section className="rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 to-white p-6">
        <p className="text-base font-bold text-amber-900">酸素欠乏危険作業特別教育のお問い合わせ・改善提案</p>
