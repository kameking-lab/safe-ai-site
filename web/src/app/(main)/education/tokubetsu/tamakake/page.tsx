...
const courseSchema = {
  ...
  name: "玉掛け 特別教育（1t未満）",
  description: DESCRIPTION,
  url: "https://www.anzen-ai-portal.jp/education/tokubetsu/tamakake",
  timeRequired: "PT9H",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "玉掛け特別教育（1t未満）", item: "https://www.anzen-ai-portal.jp/education/tokubetsu/tamakake" },
  ],
};
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-6 sm:py-8">
      ...
      <CourseConclusion
        ...
        duration="約9時間"
        basis="省令ベース"
        summary="安衛則第36条第19号・別表第5に基づく、つり上げ荷重1t未満の玉掛け業務者向け特別教育。"
      />
