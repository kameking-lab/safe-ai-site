...
const SECTIONS: DiversitySection[] = [
  {
    ...
    topics: [
      ...
      {
        title: "事業附属寄宿舎・現場トイレ",
        body: "常時労働者を使用する事業場は、男女別トイレが原則義務（安衛則第628条）。小規模現場でも合理的配慮として男女別・施錠可能・清掃頻度確保を推奨。",
        law: "安衛則第628条",
      },
    ],
    contacts: [
  ...
  },
  {
    ...
    topics: [
      {
        title: "パート・アルバイトの労災",
        body: "雇用形態・勤務日数に関係なく、労働者である限り労災保険は適用。雇入れ時の安全衛生教育（安衛則35条）は全員に必要（時間は職種によるが省略不可）。",
      },
      {
        title: "スポットワーク（タイミー等）",
      ...
      {
        title: "危険作業の拒否権",
        body: "労働者には、明白に安全を脅かす作業を一時的に中断・拒否する権利（安衛法25条・32条等の解釈）。事業者は拒否を理由とする不利益取扱いはできない。",
      },
      {
        title: "派遣労働者の責任分担",
