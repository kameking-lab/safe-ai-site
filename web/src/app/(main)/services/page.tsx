...
const FAQ = [
  ...
  {
    q: "個人事業主との契約に不安があります。事業継続性は？",
    a: "業務委託契約書に「成果物の知的財産権は発注者に帰属」「ソースコード・データの引渡条項」「保守期間中の体制継続義務」を明記します。万一の事業休止時にも、納品済みコードはお客様が独立運用できる形で引き渡します。日本労働安全衛生コンサルタント会の倫理規程を遵守した運営です。",
  },
  {
    q: "相談後にしつこい営業はありませんか？",
    a: "ありません。無料相談後は、相談内容に基づくご提案メール1通のみお送りします。その後の営業連絡はご希望に応じてオプトアウト可能（返信『今回はパスします』で追客停止）です。",
  },
];
