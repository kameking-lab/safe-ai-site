...
const TERMS: Term[] = [
  ...
  { term: "保護具", reading: "ほごぐ", definition: "労働者の身体を有害因子から保護するための用具の総称。保護帽・安全帯・呼吸用保護具・防音保護具・防振手袋・耐熱保護衣等が含まれる。適切な選択と管理が重要。", relatedPages: [{ href: "/e-learning", label: "Eラーニング" }] },
  ...
  { term: "墜落防止", reading: "ついらくぼうし", definition: "高所からの墜落による労働災害を防ぐ措置。手すり・安全帯・親綱・墜落防止ネットの設置、フルハーネス型墜落制止用器具の使用等が主な対策。", relatedPages: [{ href: "/laws", label: "法改正" }] },
