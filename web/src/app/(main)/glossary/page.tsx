...
const BASE_TERMS: Term[] = [
  ...
  { term: "衛生管理者", reading: "えいせいかんりしゃ", definition: "安衛法第12条に基づき、常時50人以上の全業種の事業場で選任義務がある者。衛生に関する技術的事項を管理し、週1回以上の作業場巡視が義務。", relatedPages: [{ href: "/chatbot", label: "法令チャット" }] },
  { term: "エックス線作業主任者", reading: "えっくすせんさぎょうしゅにんしゃ", definition: "エックス線装置を用いた作業の際に選任義務がある作業主任者。都道府県労働局長登録の講習修了者から選任する。", relatedPages: [] },
  ...
  { term: "クレーン", reading: "くれーん", definition: "荷物を動力を用いてつり上げ、水平に運搬する機械。つり上げ荷重0.5t以上は労働安全衛生法の規制対象。運転には資格が必要。", relatedPages: [{ href: "/chatbot", label: "法令チャット" }] },
  ...
  { term: "作業環境測定", reading: "さぎょうかんきょうそくてい", definition: "安衛法第65条に基づき、有害物質を取り扱う作業場で定期的に実施する濃度測定。結果をA・B・C管理区分に評価し、改善措置を講じる。", relatedPages: [{ href: "/chatbot", label: "法令チャット" }] },
  { term: "作業主任者", reading: "さぎょうしゅにんしゃ", definition: "特定の危険・有害作業において技能講習修了者から選任される者。作業の指揮、設備の点検、保護具の使用状況監視等が職務。", relatedPages: [{ href: "/chatbot", label: "法令チャット" }] },
  ...
  { term: "電離放射線", reading: "でんりほうしゃせん", definition: "アルファ線・ベータ線・ガンマ線・エックス線・中性子線等、原子を電離させるエネルギーを持つ放射線の総称。電離則により管理区域の設定・被ばく限度等が規定。", relatedPages: [{ href: "/chatbot", label: "法令チャット" }] },
  ...
  { term: "ボイラー", reading: "ぼいらー", definition: "水・熱媒体を加熱して蒸気または温水を発生させる装置。規模によりボイラー及び圧力容器安全規則（ボイラー則）の規制を受け、取扱者の資格が必要。", relatedPages: [{ href: "/chatbot", label: "法令チャット" }] },
  ...
  { term: "圧力容器", reading: "あつりょくようき", definition: "内部の圧力が大気圧と異なる液体・気体を収容する密封容器。ボイラー則の規制対象で、検査・取扱資格等が義務付けられている。定期自主検査が必要。", relatedPages: [] },
