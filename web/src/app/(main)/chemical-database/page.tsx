      ...
      <JsonLd
        schema={[
          ...
          datasetSchema({
            ...
            variableMeasured: [
              `収録物質数: ${MHLW_MERGED_CHEMICAL_COUNT}物質`,
              "規制区分",
              "濃度基準値",
              "CAS番号",
            ],
      ...
      <div className="mx-auto mt-3 max-w-7xl px-4 lg:px-8">
        <div className="rounded-lg border border-emerald-200 bg-emerald-50/60 px-4 py-2.5 text-xs text-emerald-900 dark:border-emerald-700/60 dark:bg-emerald-900/20 dark:text-emerald-200">
          ...
          <strong className="font-semibold">
            詳細情報（CAS番号・GHS分類・濃度基準値）を閲覧
          </strong>
          するDBです。 物質と作業内容を整理し、
          <em className="font-medium">簡易スクリーニング</em>を行う場合は
          <Link
            href="/chemical-ra"
            className="ml-1 underline decoration-emerald-400 underline-offset-2 hover:text-emerald-700 dark:hover:text-emerald-100"
          >
            化学物質RA
          </Link>
          を利用できます。最終評価は公式CREATE-SIMPLE、最新SDS、実測値を用いて専門家が確認してください。
        </div>
      </div>
        ...
        pages={[
          {
            ...
            label: "化学物質RA ツール",
            description:
              "検索した物質の収録済み公的情報を確認し、最新SDS・公式ツールでの評価へつなげます。",
            color: "emerald",
            cta: "リスクアセスを開始",
          },
          {
            ...
            label: "安全用品カテゴリ",
            description:
              "購入候補を確認する前に、SDSと使用条件から必要な保護具の種類を確認。",
            color: "amber",
            cta: "カテゴリを見る",
          },
          {
