...
export const metadata: Metadata = {
  title: "死亡事故データベース 説明資料（印刷用）",
  description: "死亡災害事例をA4印刷用にまとめた説明資料ビュー。データセット単位の出典と追跡上の限界を表示します。",
  alternates: { canonical: "/fatal-accidents/print" },
  ...
  return (
    <div className="mx-auto max-w-[820px] bg-white px-6 py-6 text-slate-900 print:px-0 print:py-0">
      ...
      <header className="border-b-2 border-slate-800 pb-2">
        <h1 className="text-xl font-bold">死亡事故データベース（説明資料）</h1>
