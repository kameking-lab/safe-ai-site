...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = [
    ...
    { url: "/diversity/disability", priority: 0.6, changeFrequency: "monthly" as const },
    { url: "/diversity/sogi", priority: 0.6, changeFrequency: "monthly" as const },
    { url: "/diversity/foreign-workers", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/laws/bcp", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/laws/freelance-rosai", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/laws/gig-work", priority: 0.6, changeFrequency: "monthly" as const },
    ...
    { url: "/signage", priority: 0.5, changeFrequency: "daily" as const },
    { url: "/about", priority: 0.5, changeFrequency: "yearly" as const },
    { url: "/feedback", priority: 0.5, changeFrequency: "yearly" as const },
