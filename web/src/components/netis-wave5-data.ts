...
export const NETIS_WAVE5_TECHNOLOGIES: readonly Wave5Technology[] = [
  ...
  t(["wave2-quality"], "quality", "法面・斜面安定", "ロービングウォールⅡ", "KT-180143-VE", "高精度給糸装置による吹付けで長繊維混入補強土層を造成し、法面を安定させる。", "法面 斜面 安定 吹付け"),
  t(["wave2-mechanization"], "efficiency", "地盤改良", "パワーブレンダー工法(横行施工)", "QS-180038-VE", "角度変換できる撹拌機で横行方向へ連続施工し、狭隘・近接箇所の中層地盤を改良する。", "地盤 改良 撹拌 狭隘"),
  t(["wave2-quality"], "quality", "法面・侵食対策", "侵食防止及び植生の自然侵入促進をはかる土壌藻類資材", "OK-170002-VR", "土壌藻類資材を裸地や法面に吹き付け、被覆形成による侵食抑制と植生の自然侵入を促す。", "法面 侵食 植生 土壌"),
  ...
  t(["wave2-quality"], "quality", "橋梁・床版排水", "高機能床版排水パイプ", "HK-200001-VE", "道路橋の床版の水抜きに用いる排水パイプである。", "橋梁 床版 排水 パイプ"),
