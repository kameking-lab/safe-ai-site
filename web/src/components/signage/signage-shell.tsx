...
export function SignageShell({ children }: SignageShellProps) {
  return (
    <div className="flex min-h-screen w-full flex-col overflow-x-hidden bg-slate-900 text-slate-50 xl:h-[100dvh] xl:min-h-0 xl:overflow-hidden [touch-action:manipulation]">
