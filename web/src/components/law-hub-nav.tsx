...
// 補助テキストで二重に提供する。
const NAV_ITEMS = [
  { id: "laws" as const, href: "/laws", label: "法改正一覧", description: "施行日カウントダウン付きの改正カレンダー（時系列ビュー）" },
  { id: "law-search" as const, href: "/law-search", label: "条文検索", description: "条文番号・キーワードで安衛法・安衛則を全文検索" },
  { id: "law-hierarchy" as const, href: "/law-hierarchy", label: "法令体系", description: "法→政令→省令→告示の階層構造を俯瞰" },
  { id: "circulars" as const, href: "/circulars", label: "通達DB", description: "厚労省 通達・告示・指針 1,069 件をキーワード+期間+種別で検索" },
  { id: "glossary" as const, href: "/glossary", label: "用語集", description: "労働安全衛生の用語を辞書形式で解説" },
  { id: "chatbot" as const, href: "/chatbot", label: "AIチャット", description: "条文番号と出典付きで自然文の質問に回答" },
];
