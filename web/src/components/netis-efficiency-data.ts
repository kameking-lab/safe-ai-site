...
export const NETIS_EFFICIENCY_CATEGORIES = [
  {
    ...
    label: "測量・出来形",
    image: "/netis-safety/categories/surveying.jpg",
    imageAlt: "測量用のトータルステーションとプリズムが並ぶ実写。技術固有の製品写真ではありません。",
    imageCredit: {
      title: "Surveying prism and total station, for land surveying, in Shibuya-ku.jpg",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Surveying_prism_and_total_station,_for_land_surveying,_in_Shibuya-ku.jpg",
      author: "Syced",
      license: "CC0 1.0",
      licenseUrl: "https://creativecommons.org/publicdomain/zero/1.0/",
      retrievedAt: "2026-09-25",
      changeNote: "Wikimediaの960px縮小版を取得。表示時にCSSで切り抜き。",
    },
  ...
  },
  {
    ...
    label: "記録・点検",
    image: "/netis-safety/categories/bridge-inspection.jpg",
    imageAlt: "橋梁を点検する高所作業車が写る実写。技術固有の製品写真ではありません。",
    imageCredit: {
      title: "BRIDGE 2021.02.23 BasnightBridgeInspection -32.jpg",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:BRIDGE_2021.02.23_BasnightBridgeInspection_-32.jpg",
