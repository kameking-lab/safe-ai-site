  ...
  const aboutCopy = (
    <>
      ...
      <p className="mt-2 text-sm leading-7 text-slate-700">
        本ガイドは、安全AIポータル編集部が運用する研究プロジェクト
        <Link href="/about" className="underline hover:text-emerald-700">
          「安全AIポータル」
        </Link>
        が、検索者の質問に最短で答えることを目的に作成した解説ページです。プロジェクトは労働安全コンサルタント監修ですが、個別ページの確認状態は本文の表示を優先します。AIによる回答や本ガイドの記述は最新法令や個別事案の判断を保証するものではありません。具体的な判断は必ず原典（e-Gov・厚労省・所轄労働基準監督署・専門家）でご確認ください。
      </p>
