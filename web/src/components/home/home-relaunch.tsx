...
@media(min-width:640px){.hs-section{padding:3.5rem 1.5rem}.hs-title{font-size:2.25rem}.hs-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.hs-quick{display:none}}
