...
- [ ] 【柱0バッチ9/9】その他ツール(/strategy/plan-generator・/subsidies+calculator・/bcp・/organization・/insurance・/chemical-database・/goods・/leaflet・/newsletter)=各ツールの判定/件数結論カードと文字ダイエット。
