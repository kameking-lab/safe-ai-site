...
- [ ] 【柱0仕上げ】記録系・受入教育・健診スケジューラで結論カード/無読テストが未達の画面を巡回し是正（バッチ1/3/5の積み残し・本番実機で確認）。巡回の結果、記録系(site-records 全subroute・safety-diary・education-certification)は結論カード済みで合格。未達3画面=/education・/foreign-workers・/health-checkup-scheduler を個別是正中。
  - [x] /education: 教材カタログ最上部に ConclusionCard「12種 教育プログラム公開中」＋「教育を選ぶ」#programs。無読11/11合格。(2026-06-14, #536)
  - [x] /health-checkup-scheduler(入口): ConclusionCard「30種 健診を自動判定」＋8区分/106職種/無料＋「入力をはじめる」#scheduler-form。長文はCollapsibleDetailへ。無読12/12合格。(2026-06-14, #543)
  - [x] /foreign-workers: ConclusionCard「国籍問わず法令適用」＋在留11資格/教材30本/5言語対応/無料＋「教材を作る」。重複していた件数タイル(dl)を結論カードへ一本化。無読11/11合格。(2026-06-14, #PR)
