# BACKLOG-plain-3 — 現場ことば版 部隊3（有機則＋鉛則＋四アルキル鉛則＋特化則）

執筆規約と完了条件の正本: docs/plain-language-prompts/README.md。
部隊投入プロンプト: docs/plain-language-prompts/squad-3.md（1タスク=1法令。
法令別の詳細手順は docs/plain-language-prompts/<ファイル>.md）。
見本（品質基準）: web/src/data/plain/sankketsu-kisoku.ts（酸欠則16条・fidelity全緑・完成済み）。
